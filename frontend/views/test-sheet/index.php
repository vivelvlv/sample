...
<div class="test-sheet-index">
    ...
    $gridColumns = [
        ...
        ['class' => 'kartik\grid\ActionColumn',
            ...
            'buttons' => [
                'update-sheet-samples' => function ($url, $model, $key) {
                    $options = [
                        'title' => Yii::t('yii', 'Samples'),
                        'aria-label' => Yii::t('yii', 'Samples'),
                        'data-pjax' => '0',
                    ];
                    return Html::a('<span class="fa  fa-flask"></span>', $url, $options);
                },
...
$urlPrintMultiple = Url::to(['test-sheet/print-list']);

$urlPrintMultipleItemPage = Url::to(['test-sheet/print']);

$script = <<< JS
var updateModal =  $('#updateModal');
$('#test_sheet_grid-pjax').on('click','a[name="modalUpdate"]',function(e){
