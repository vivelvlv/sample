...
/* @var $searchModel backend\models\SampleTypeSearch */
...
//   karnbrockgmbh\modal\Modal::end();
       ...
       //create
       Modal::begin([
            'header'=>'<h4>'.Yii::t('backend', 'Sample Type').' </h4>',
            'id'=>'createModel',
            'size'=>'modal-md',
           ]);
  ...
  <?php 
    ...
    echo  GridView::widget([
          ...
          'toolbar'=> [
              ['content'=>
              Html::button('<i class="glyphicon glyphicon-plus"></i>',['value'=>Url::to(['sample-type/create']),
                                                               'title'=>Yii::t('backend', 'Create Sample Type'),
          ...
          'panel'=>[
            ...
            'heading'=>'<h3 class="panel-title"><i class="fa fa-flask"></i>  '.Yii::t('backend','Sample Type').'</h3>',
            'before' =>  '<div style="padding-top: 7px;"><em>*'.Yii::t('backend','Show All Sample Type').'</em></div>',
          ], 
          'options'=>['id'=>'sample_type_grid']
      ]);
   ?>
...
$('#sample_type_grid-pjax').on('click','a[name="modalUpdate"]',function(e){
...
$('#updateModal').on('kbModalSubmit', function(event, data, status, xhr) 
{
    ...
    $.pjax.reload({container:'#sample_type_grid-pjax'});
});

$('#sample_type_grid-pjax').on('click','a[name="modalView"]',function(e){
...
$('#sample_type_grid-pjax').on('click','#createSampleButton',function(e){
