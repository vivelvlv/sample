 ...
 */
class SampleServiceMyTestSearch extends SampleService
{
    public $barcodes;
    ...
    public static function statusListItems()
    {
        return
            [
                self::SAMPLESERVICE_STATUS_IN_TEST => Yii::t('backend', 'In Test'),
                self::SAMPLESERVICE_STATUS_COMPLETE => Yii::t('backend', 'Complete'),
                self::SAMPLESERVICE_STATUS_IN_EXCEPTION_BACK => Yii::t('backend', 'Exception'),
            ];
    }
