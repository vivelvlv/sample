...
<!--#if !(FIREFOX || MOZCENTRAL || CHROME)-->
    <script type="text/javascript" nasrc="<?php echo $baseUrl; ?>/web/compatibility.js"></script>
<!--#endif-->
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="download" class="toolbarButton download" title="Download" tabindex="15" data-l10n-id="download" hidden="true">
